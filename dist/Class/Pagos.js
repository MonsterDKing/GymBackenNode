...
var Pago = /** @class */ (function () {
    ...
    Pago.efectuarPagoSumado = function (idcliente) {
        return __awaiter(this, void 0, void 0, function () {
            var consulta;
            return __generator(this, function (_a) {
                consulta = "SELECT \n        * \n      FROM\n        pagos \n      WHERE cliente = 1 \n      ORDER BY id DESC \n      LIMIT " + idcliente + " ";
                mysql_1.default.ejecutarQuery(consulta, function (err, respuesta) {
                    var fechaPagoActual = String(respuesta[0].fecha);
                    var date = new Date(fechaPagoActual);
    ...
    Pago.verificarPrimeraVez = function (idcliente) {
        return __awaiter(this, void 0, void 0, function () {
            var consulta;
            return __generator(this, function (_a) {
                consulta = "SELECT * FROM pagos where cliente = " + idcliente;
                mysql_1.default.ejecutarQuery(consulta, function (err, respuesta) {
                    if (err) {
                        return true;
                    }
